...
const revealClassList = ['btn', 'client-logo-wrapper', 'about-card', 'service-card', 'testimonial-card', 'section-pre-title', 'section-title', 'section-description', 'cta-content', 'footer-col li', 'footer-col p','footer-col a', , 'footer-col h4', 'footer-bottom', 'service-detail-header', 'tier', 'accordion-toggle', 'checklist li', 'steps li', 'service-detail-col h3', 'border-in-between' , 'service-nav-link' , 'floating' , 'form-group-services' , 'contact-icon' , 'contact-information' , 'contact-info-1 h2', 'contact-info-1 p' , 'hero-title' , 'hero-subtitle' , 'hero-cta' , 'story-image' , 'story-content p' , 'story-content h2' , 'stat-card' , 'values-section h2' , 'value-card h3' , 'value-card p' , 'value-icon' , 'team-card-front' , 'team-section h2' , 'clients-section h2' , 'client-cta h2', 'client-cta p', 'client-info' , 'quote' , 'case-content h4' , 'case-content p' , 'read-more' , 'case-image', 'tab-btn'];
